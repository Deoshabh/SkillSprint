  ...
  return (
    <>
      <Button
        variant="default"
        size="icon"
        className="fixed bottom-20 right-4 md:bottom-6 md:right-6 h-12 w-12 md:h-14 md:w-14 rounded-full shadow-lg z-50 mobile-tap"
        onClick={toggleChat}
      ...
      {isOpen && (
        <Card className="fixed bottom-20 right-4 left-4 md:bottom-24 md:right-6 md:left-auto md:w-full md:max-w-sm h-[60vh] max-h-[500px] shadow-xl z-40 flex flex-col bg-card border border-border animate-fade-in safe-area-inset-bottom">
                  ...
                  >
                    ...
                    >
                     ...
                     {message.role === 'user' && user && (
                      <Avatar className="h-7 w-7 flex-shrink-0">
                        <AvatarImage src={getValidAvatarUrl(user.avatarUrl)} alt={user.name} />

  ...
  useEffect(() => {
    if (currentUser) {
      ...
      const userProfile: UserProfile = {
        ...
        customVideoLinks: currentUser.customVideoLinks,
        userModuleVideos: currentUser.userModuleVideos,
        textNotes: currentUser.textNotes,
        sketches: currentUser.sketches,
        uploadedImages: currentUser.uploadedImages,
        dailyPlans: currentUser.dailyPlans,
        profileSetupComplete: currentUser.profileSetupComplete,
        submittedFeedback: currentUser.submittedFeedback
      };

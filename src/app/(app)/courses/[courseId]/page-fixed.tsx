...
import { CheckCircle, Clock, Users, Star, ArrowLeft, Share2, Bookmark, Award, Code, Sigma, Zap, Mic, Palette, Brain, Loader2, Edit, Trash2, type LucideIcon } from 'lucide-react';
              ...
              <div className="space-y-4">
                <Button asChild className="w-full" size="lg">
                  <Link href={`/courses/${params.courseId}/module/${course.modules[0]?.id || ''}`}>
                    ...
                    {userProgress && progressPercentage > 0 ? 'Continue Learning' : 'Start Course'}
                  </Link>
                </Button>
